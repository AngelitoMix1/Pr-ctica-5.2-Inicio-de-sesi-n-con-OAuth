  ...
  if (proxy) {
    ...
    if (proxyAuth) {
      ...
      if (validProxyAuth) {
        ...
        throw new AxiosError_default("Invalid proxy authorization", AxiosError_default.ERR_BAD_OPTION, {
          proxy
        });
      }
  ...
  return wrapAsync(function dispatchHttpRequest(resolve, reject, onDone) {
    return __async(this, null, function* () {
      ...
      function createTimeoutError() {
        ...
        return new AxiosError_default(timeoutErrorMessage, transitional2.clarifyTimeoutError ? AxiosError_default.ETIMEDOUT : AxiosError_default.ECONNABORTED, config, req);
      }
      ...
      if (utils_default.isStream(data)) {
        ...
        if (config.maxBodyLength > -1 && config.maxRedirects === 0) {
          ...
          let bytesSent = 0;
          uploadStream = stream3.pipeline([data, new stream3.Transform({
